        ...
        <div class="row d-flex justify-content-center align-items-center h-100">
          <div class="col-12 col-md-8 col-lg-6 col-xl-5">
            <div class="card bg-white text-black" style="border-radius: 1rem;">
              <form class="" action="/updatemeal" method="post">
                @csrf
              <div class="card-body p-5 text-center">
                <div class="mb-md-5 mt-md-4 pb-5">
                  <h2 class="fw-bold mb-2 text-uppercase">Update Meal</h2>
                  <div class="form-outline form-white mb-4">
                    <input type="text" class="form-control form-control-lg" name="meal_name">
                    <label class="form-label" for="typeEmailX">Meal Name</label>
                  </div>
                  <div class="form-outline form-white mb-4">
                    ...
                    <label class="form-label" for="typePasswordX">Meal Type</label>
                  </div>
                  <button class="btn btn-outline-dark btn-lg px-5" type="submit">Update Meal </button>
