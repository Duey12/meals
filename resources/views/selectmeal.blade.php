      ...
      <div class="row d-flex justify-content-center align-items-center h-100">
        <div class="col-12 col-md-8 col-lg-6 col-xl-5">
          <div class="card bg-white text-black" style="border-radius: 1rem;">
            <form class="" action="/logselection" method="post">
              @csrf
            <div class="card-body p-5 text-center">
              <div class="mb-md-5 mt-md-4 pb-5">
                <h2 class="fw-bold mb-2 text-uppercase">Select Meal</h2>
                <div class="form-outline form-white mb-4">
                  <select class="form-control" name="meal">
                    <option value=""></option>
                    @foreach($meals as $meal)
                    <option value="{{$meal['id']}}">{{$meal['meal_type']}}</option>
                    @endforeach
                  </select>
                  <label class="form-label" for="meal">Meals</label>
                </div>
                <div class="form-outline form-white mb-4">
